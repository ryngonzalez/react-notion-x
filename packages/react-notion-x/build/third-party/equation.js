...
var PageIconImpl = ({
  ...
  if (isIconBlock(block)) {
    ...
    if (icon && isUrl(icon)) {
      ...
      isImage = true;
      content = /* @__PURE__ */ React7.createElement(LazyImage, {
        src: url,
        alt: title || "page icon",
      ...
      if (!hideDefaultIcon) {
        isImage = true;
        content = /* @__PURE__ */ React7.createElement(DefaultPageIcon, {
          className: cs(className, "notion-page-icon"),
      ...
      isImage = false;
      content = /* @__PURE__ */ React7.createElement("span", {
        className: cs(className, "notion-page-icon"),
        role: "img",
        "aria-label": icon
      }, icon);
...
var PageTitleImpl = (_a) => {
  ...
  if (block.type === "collection_view_page" || block.type === "collection_view") {
    ...
    return /* @__PURE__ */ React8.createElement("span", __spreadValues({
      className: cs("notion-page-title", className)
    }, rest), /* @__PURE__ */ React8.createElement(PageIcon, {
      block,
      defaultIcon,
      ...
      (element, decorator) => {
        ...
        switch (decorator[0]) {
          case "p": {
            ...
            return /* @__PURE__ */ React9.createElement(components.PageLink, {
              className: "notion-link",
              href: mapPageUrl(blockId)
            }, /* @__PURE__ */ React9.createElement(PageTitle, {
              block: linkedBlock
            }));
          }
          case "\u2023": {
            ...
            switch (linkType) {
              case "u": {
                ...
                return /* @__PURE__ */ React9.createElement(GracefulImage, {
              ...
              default: {
                ...
                return /* @__PURE__ */ React9.createElement(components.PageLink, __spreadProps(__spreadValues({
                  className: "notion-link",
                  href: mapPageUrl(id)
                }, linkProps), {
                  target: "_blank",
          ...
          case "c":
            return /* @__PURE__ */ React9.createElement("code", {
          ...
          case "e":
            return /* @__PURE__ */ React9.createElement(components.Equation, {
              math: decorator[1],
              inline: true
            });
          case "m":
          ...
          case "a": {
            ...
            if ((v[0] === "/" || v.includes(rootDomain)) && id) {
              ...
              return /* @__PURE__ */ React9.createElement(components.PageLink, __spreadValues({
                className: "notion-link",
                href
              }, linkProps), element);
            } else {
              return /* @__PURE__ */ React9.createElement(components.Link, __spreadValues({
                className: "notion-link",
          ...
          case "eoi": {
            ...
            return /* @__PURE__ */ React9.createElement(EOI, {
...
var SearchIcon = (props) => {
  ...
  return /* @__PURE__ */ React10.createElement("svg", __spreadValues({
    ...
    viewBox: "0 0 17 17"
  }, rest), /* @__PURE__ */ React10.createElement("path", {
...
var LoadingIcon = (props) => {
  ...
  return /* @__PURE__ */ React12.createElement("svg", __spreadProps(__spreadValues({
    ...
    viewBox: "0 0 24 24"
  }), /* @__PURE__ */ React12.createElement("defs", null, /* @__PURE__ */ React12.createElement("linearGradient", {
    x1: "28.1542969%",
    y1: "63.7402344%",
    x2: "74.6289062%",
    y2: "17.7832031%",
    id: "linearGradient-1"
  }, /* @__PURE__ */ React12.createElement("stop", {
...
var SearchDialog = class extends React13.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ React13.createElement(NotionContextConsumer, null, (ctx2) => {
      ...
      return /* @__PURE__ */ React13.createElement(components.Modal, {
        isOpen,
        contentLabel: "Search",
      ...
      }, isLoading ? /* @__PURE__ */ React13.createElement(LoadingIcon, {
        className: "loadingIcon"
      }) : /* @__PURE__ */ React13.createElement(SearchIcon, null)), /* @__PURE__ */ React13.createElement("input", {
        className: "searchInput",
        placeholder: "Search",
        value: query,
        ref: this._inputRef,
        onChange: this._onChangeQuery
      }), query && /* @__PURE__ */ React13.createElement("div", {
        role: "button",
        className: "clearButton",
        onClick: this._onClearQuery
      }, /* @__PURE__ */ React13.createElement(ClearIcon, {
        className: "clearIcon"
      }))), hasQuery && searchResult && /* @__PURE__ */ React13.createElement(React13.Fragment, null, searchResult.results.length ? /* @__PURE__ */ React13.createElement(NotionContextProvider, __spreadProps(__spreadValues({}, ctx2), {
        ...
        }), ((_a = result.highlight) == null ? void 0 : _a.html) && /* @__PURE__ */ React13.createElement("div", {
          className: "notion-search-result-highlight",
          dangerouslySetInnerHTML: {
            __html: result.highlight.html
          }
        }));
      })), /* @__PURE__ */ React13.createElement("footer", {
        className: "resultsFooter"
      }, /* @__PURE__ */ React13.createElement("div", null, /* @__PURE__ */ React13.createElement("span", {
        className: "resultsCount"
      }, searchResult.total), searchResult.total === 1 ? " result" : " results"))) : /* @__PURE__ */ React13.createElement("div", {
        className: "noResultsPane"
      }, /* @__PURE__ */ React13.createElement("div", {
        className: "noResults"
      }, "No results"), /* @__PURE__ */ React13.createElement("div", {
        className: "noResultsDetail"
      }, "Try different search terms"))), hasQuery && !searchResult && searchError && /* @__PURE__ */ React13.createElement("div", {
        className: "noResultsPane"
      }, /* @__PURE__ */ React13.createElement("div", {
        className: "noResults"
      }, "Search error"))));
...
var Header = ({ block }) => {
  ...
  }, /* @__PURE__ */ React14.createElement(Breadcrumbs, {
    block
  }), /* @__PURE__ */ React14.createElement(Search, {
    block
  })));
};
var Breadcrumbs = ({ block, rootOnly = false }) => {
  ...
  return /* @__PURE__ */ React14.createElement("div", {
    ...
    return /* @__PURE__ */ React14.createElement(React14.Fragment, {
      key: breadcrumb.pageId
    }, /* @__PURE__ */ React14.createElement(componentMap.pageLink, __spreadValues({
      className: cs("breadcrumb", breadcrumb.active && "active")
    }, pageLinkProps), breadcrumb.icon && /* @__PURE__ */ React14.createElement(PageIcon, {
      className: "icon",
      block: breadcrumb.block
    }), breadcrumb.title && /* @__PURE__ */ React14.createElement("span", {
      className: "title"
    }, breadcrumb.title)), index < breadcrumbs.length - 1 && /* @__PURE__ */ React14.createElement("span", {
      className: "spacer"
    }, "/"));
  }));
};
var Search = ({ block, search, title = "Search" }) => {
  ...
  return /* @__PURE__ */ React14.createElement(React14.Fragment, null, hasSearch && /* @__PURE__ */ React14.createElement("div", {
    role: "button",
    className: cs("breadcrumb", "button", "notion-search-button"),
    onClick: onOpenSearch
  }, /* @__PURE__ */ React14.createElement(SearchIcon, {
    className: "searchIcon"
  }), title && /* @__PURE__ */ React14.createElement("span", {
    className: "title"
  }, title)), isSearchOpen && hasSearch && /* @__PURE__ */ React14.createElement(SearchDialog, {
    isOpen: isSearchOpen,
...
var LiteYouTubeEmbed = ({
  ...
  return /* @__PURE__ */ React15.createElement(React15.Fragment, null, /* @__PURE__ */ React15.createElement("link", {
    rel: "preload",
    href: posterUrl,
    as: "image"
  }), isPreconnected && /* @__PURE__ */ React15.createElement(React15.Fragment, null, /* @__PURE__ */ React15.createElement("link", {
    rel: "preconnect",
    href: ytUrl
  }), /* @__PURE__ */ React15.createElement("link", {
    rel: "preconnect",
    href: "https://www.google.com"
  })), isPreconnected && adLinksPreconnect && /* @__PURE__ */ React15.createElement(React15.Fragment, null, /* @__PURE__ */ React15.createElement("link", {
    rel: "preconnect",
  ...
  }), iframeInitialized && /* @__PURE__ */ React15.createElement("iframe", {
    width: "560",
    height: "315",
    frameBorder: "0",
...
var Asset = ({ block, zoomable = true, children }) => {
  ...
  if (block.type === "tweet") {
    ...
    }, /* @__PURE__ */ React16.createElement(components.Tweet, {
      id
    }));
    ...
    if (!isServer) {
      content = /* @__PURE__ */ React16.createElement(components.Pdf, {
        file: source
      });
    }
    ...
    if (block.type === "video" && source && source.indexOf("youtube") < 0 && source.indexOf("youtu.be") < 0 && source.indexOf("vimeo") < 0 && source.indexOf("wistia") < 0 && source.indexOf("loom") < 0 && source.indexOf("videoask") < 0 && source.indexOf("getcloudapp") < 0) {
      ...
      content = /* @__PURE__ */ React16.createElement("video", {
      ...
      if (src) {
        ...
        if (youtubeVideoId) {
          content = /* @__PURE__ */ React16.createElement(LiteYouTubeEmbed, {
            id: youtubeVideoId,
            style: assetStyle,
          ...
          style.paddingBottom = "50%";
          content = /* @__PURE__ */ React16.createElement("iframe", {
            style: assetStyle,
            className: "notion-asset-object-fit",
            src,
            title: "GitHub Gist",
    ...
    content = /* @__PURE__ */ React16.createElement(LazyImage, {
      src,
      alt,
      zoomable,
      height: style.height,
...
var AssetWrapper = ({ blockId, block }) => {
  ...
  const figure = /* @__PURE__ */ React17.createElement("figure", {
    ...
    block: value,
    zoomable: zoom && !isURL
  }, ((_f = value == null ? void 0 : value.properties) == null ? void 0 : _f.caption) && !isURL && !isVideoParams && value.type !== "video" && /* @__PURE__ */ React17.createElement("figcaption", {
...
var wrapNextImage = (NextImage) => {
  return React20.memo(function ReactNotionXNextImage(_a) {
    ...
    return /* @__PURE__ */ React20.createElement(NextImage, __spreadValues({
      className,
      src,
      alt,
...
var wrapNextLink = (NextLink) => function ReactNotionXNextLink(_a) {
  ...
  return /* @__PURE__ */ React20.createElement(NextLink, {
    href,
    as,
    passHref,
    prefetch,
...
// src/context.tsx
var DefaultLink = (props) => /* @__PURE__ */ React21.createElement("a", __spreadValues({
  target: "_blank",
  rel: "noopener noreferrer"
}, props));
...
var NotionContextProvider = (_a) => {
  ...
  return /* @__PURE__ */ React21.createElement(ctx.Provider, {
    value
  }, children);
};
...
var Equation = (_a) => {
  ...
  }, /* @__PURE__ */ React22.createElement(Katex, __spreadValues({
    math,
