...
var MentionPreviewCard = ({ owner, lastUpdated, externalImage, title, domain }) => {
  ...
  }, capitalizeFirstLetter(domain.split(".")[0]))), /* @__PURE__ */ React2.createElement("div", {
    className: "notion-preview-card-title"
  }, title), owner && /* @__PURE__ */ React2.createElement("div", {
    className: "notion-external-subtitle-item"
  }, /* @__PURE__ */ React2.createElement("div", {
    className: "notion-external-subtitle-item-name"
  }, "Owner"), /* @__PURE__ */ React2.createElement("span", {
    className: "notion-external-subtitle-item-desc"
  }, owner)), lastUpdated && /* @__PURE__ */ React2.createElement("div", {
    className: "notion-external-subtitle-item"
  }, /* @__PURE__ */ React2.createElement("div", {
    className: "notion-external-subtitle-item-name"
  }, "Updated"), /* @__PURE__ */ React2.createElement("span", {
    className: "notion-external-subtitle-item-desc"
  }, lastUpdated)), domain === "github.com" && /* @__PURE__ */ React2.createElement("div", {
...
var EOI = ({ block, inline, className }) => {
  ...
  return /* @__PURE__ */ React3.createElement(components.Link, {
    target: "_blank",
  ...
  }, externalImage && /* @__PURE__ */ React3.createElement("div", {
    className: "notion-external-image"
  }, externalImage), /* @__PURE__ */ React3.createElement("div", {
    className: "notion-external-description"
  }, /* @__PURE__ */ React3.createElement("div", {
    className: "notion-external-title"
  }, title), (owner || lastUpdated) && /* @__PURE__ */ React3.createElement(MentionPreviewCard, {
    title,
    owner,
    lastUpdated,
    domain,
...
var PageTitleImpl = (_a) => {
  ...
  if (block.type === "collection_view_page" || block.type === "collection_view") {
    ...
    return /* @__PURE__ */ React5.createElement("span", __spreadValues({
      className: cs("notion-page-title", className)
    }, rest), /* @__PURE__ */ React5.createElement(PageIcon, {
      block,
      defaultIcon,
  ...
  return /* @__PURE__ */ React6.createElement(React6.Fragment, null, value == null ? void 0 : value.map(([text, decorations], index) => {
    if (!decorations) {
      if (text === ",") {
        ...
        return /* @__PURE__ */ React6.createElement(React6.Fragment, {
          key: index
        }, text);
      }
    }
      ...
      (element, decorator) => {
        ...
        switch (decorator[0]) {
          case "p": {
            ...
            return /* @__PURE__ */ React6.createElement(components.PageLink, {
              className: "notion-link",
              href: mapPageUrl(blockId)
            }, /* @__PURE__ */ React6.createElement(PageTitle, {
              block: linkedBlock
            }));
          }
          case "\u2023": {
            ...
            switch (linkType) {
              case "u": {
                ...
                return /* @__PURE__ */ React6.createElement(GracefulImage, {
              ...
              default: {
                ...
                return /* @__PURE__ */ React6.createElement(components.PageLink, __spreadProps(__spreadValues({
                  className: "notion-link",
                  href: mapPageUrl(id)
                }, linkProps), {
                  target: "_blank",
          ...
          case "c":
            return /* @__PURE__ */ React6.createElement("code", {
          ...
          case "e":
            return /* @__PURE__ */ React6.createElement(components.Equation, {
              math: decorator[1],
              inline: true
            });
          case "m":
          ...
          case "a": {
            ...
            if ((v[0] === "/" || v.includes(rootDomain)) && id) {
              ...
              return /* @__PURE__ */ React6.createElement(components.PageLink, __spreadValues({
                className: "notion-link",
                href
              }, linkProps), element);
            } else {
              return /* @__PURE__ */ React6.createElement(components.Link, __spreadValues({
                className: "notion-link",
          ...
          case "eoi": {
            ...
            return /* @__PURE__ */ React6.createElement(EOI, {
...
var LazyImage = (_a) => {
  ...
  if (previewImage) {
    ...
    if (components.Image) {
      return /* @__PURE__ */ React7.createElement(components.Image, {
        src,
        alt,
        style,
        className,
    ...
    return /* @__PURE__ */ React7.createElement(LazyImageFull, __spreadProps(__spreadValues({
      src
    }, rest), {
    ...
    return /* @__PURE__ */ React7.createElement("img", __spreadValues({
      className,
      style,
      src,
      alt,
...
var AssetWrapper = ({ blockId, block }) => {
  ...
  const figure = /* @__PURE__ */ React15.createElement("figure", {
    ...
    block: value,
    zoomable: zoom && !isURL
  }, ((_e = value == null ? void 0 : value.properties) == null ? void 0 : _e.caption) && !isURL && !isVideoParams && /* @__PURE__ */ React15.createElement("figcaption", {
...
var DefaultPageIcon = (props) => {
  const _a = props, { className } = _a, rest = __objRest(_a, ["className"]);
  return /* @__PURE__ */ React20.createElement("svg", __spreadProps(__spreadValues({
    className
  }, rest), {
    viewBox: "0 0 30 30",
    width: "16"
...
var PageIconImpl = ({
  ...
  if (isIconBlock(block)) {
    ...
    if (icon && isUrl(icon)) {
      ...
      if (!hideDefaultIcon) {
        isImage = true;
        content = /* @__PURE__ */ React21.createElement(DefaultPageIcon, {
          className: cs(className, "notion-page-icon"),
      ...
      isImage = false;
      content = /* @__PURE__ */ React21.createElement("span", {
        className: cs(className, "notion-page-icon"),
        role: "img",
        "aria-label": icon
      }, icon);
...
var CollectionColumnTitle = ({ schema }) => {
  ...
  }, /* @__PURE__ */ React44.createElement(PropertyIcon, {
...
var PropertyImpl = (props) => {
  ...
  const renderTextValue = React45.useMemo(
    () => function TextProperty() {
      return /* @__PURE__ */ React45.createElement(Text, {
        value: data,
        block
      });
    },
  ...
  const renderTitleValue = React45.useMemo(
    () => function FormulaTitle() {
      if (block && linkToTitlePage) {
        return /* @__PURE__ */ React45.createElement(components.PageLink, {
          className: cs("notion-page-link"),
          href: mapPageUrl(block.id)
        }, /* @__PURE__ */ React45.createElement(PageTitle, {
          block
        }));
      } else {
        return /* @__PURE__ */ React45.createElement(Text, {
  ...
  const renderFileValue = React45.useMemo(
    () => function FileProperty() {
      ...
      return files.map((file, i) => /* @__PURE__ */ React45.createElement(components.Link, {
        key: i,
        className: "notion-property-file",
        href: mapImageUrl(file[2], block),
        target: "_blank",
        rel: "noreferrer noopener"
      }, /* @__PURE__ */ React45.createElement(GracefulImage, {
        alt: file[0],
  ...
  const renderCheckboxValue = React45.useMemo(
    () => function CheckboxProperty() {
      ...
      }, /* @__PURE__ */ React45.createElement(Checkbox, {
        isChecked,
        blockId: void 0
  ...
  if (data || schema.type === "checkbox" || schema.type === "title" || schema.type === "formula" || schema.type === "created_by" || schema.type === "last_edited_by" || schema.type === "created_time" || schema.type === "last_edited_time") {
    switch (schema.type) {
      ...
      case "date":
        ...
        break;
      default:
        content = /* @__PURE__ */ React45.createElement(Text, {
          value: data,
          block
        });
        break;
...
var CollectionRow = ({ block, pageHeader = false, className }) => {
  ...
  return /* @__PURE__ */ React46.createElement("div", {
    ...
    return /* @__PURE__ */ React46.createElement("div", {
      ...
      key: propertyId
    }, /* @__PURE__ */ React46.createElement(CollectionColumnTitle, {
      schema
    }), /* @__PURE__ */ React46.createElement("div", {
...
var EmptyIcon = (props) => {
  const _a = props, { className } = _a, rest = __objRest(_a, ["className"]);
  return /* @__PURE__ */ React47.createElement("svg", __spreadProps(__spreadValues({
    className
  }, rest), {
    viewBox: "0 0 14 14",
    width: "14"
...
var CollectionCard = (_a) => {
  ...
  const innerCard = /* @__PURE__ */ React48.createElement(React48.Fragment, null, (coverContent || (cover == null ? void 0 : cover.type) !== "none") && /* @__PURE__ */ React48.createElement("div", {
  ...
  return /* @__PURE__ */ React48.createElement(NotionContextProvider, __spreadProps(__spreadValues({}, ctx2), {
    components: __spreadProps(__spreadValues({}, ctx2.components), {
      Link: (props) => {
        var _a3, _b3, _c2;
        return /* @__PURE__ */ React48.createElement("form", {
          action: props.href,
          target: "_blank"
  ...
  }), isLinkCollectionToUrlProperty && url ? /* @__PURE__ */ React48.createElement(components.Link, __spreadValues({
    className: cs(
    ...
    href: url
  }, rest), innerCard) : /* @__PURE__ */ React48.createElement(components.PageLink, __spreadValues({
    className: cs(
      "notion-collection-card",
      `notion-collection-card-size-${coverSize}`,
      className
...
var CollectionGroup = (_a) => {
  ...
  if (hidden)
    return null;
  return /* @__PURE__ */ React49.createElement("details", __spreadValues({
    open: true,
    className: "notion-collection-group"
  }, detailsProps), /* @__PURE__ */ React49.createElement("summary", __spreadValues({
    className: "notion-collection-group-title"
  }, summaryProps), /* @__PURE__ */ React49.createElement("div", null, /* @__PURE__ */ React49.createElement(Property, {
    schema,
    data: [[value]],
    collection
  }), /* @__PURE__ */ React49.createElement("span", {
    className: "notion-board-th-count"
  }, collectionGroup == null ? void 0 : collectionGroup.total))), /* @__PURE__ */ React49.createElement(CollectionViewComponent, __spreadValues({
    collection,
    collectionGroup
  }, rest)));
};
...
var CollectionViewBoard = ({
  ...
  if (isGroupedCollection) {
    ...
    return collectionGroups.map((group, index) => /* @__PURE__ */ React50.createElement(CollectionGroup, __spreadProps(__spreadValues({
      key: index
    }, group), {
      summaryProps: {
        style: {
      ...
      collectionViewComponent: (props) => /* @__PURE__ */ React50.createElement(Board, __spreadValues({
        padding
      }, props))
    })));
  }
  return /* @__PURE__ */ React50.createElement(Board, {
    padding,
    collectionView,
    collection,
    collectionData
...
function Board({ collectionView, collectionData, collection, padding }) {
  ...
  return /* @__PURE__ */ React50.createElement("div", {
    ...
    return /* @__PURE__ */ React50.createElement("div", {
    ...
    }, ((_b2 = group.value) == null ? void 0 : _b2.value) ? /* @__PURE__ */ React50.createElement(Property, {
      schema,
      data: [
        [
      ...
      collection
    }) : /* @__PURE__ */ React50.createElement("span", null, /* @__PURE__ */ React50.createElement(EmptyIcon, {
      className: "notion-board-th-empty"
    }), " No Select"), /* @__PURE__ */ React50.createElement("span", {
      className: "notion-board-th-count"
    }, group.total)));
  }))), /* @__PURE__ */ React50.createElement("div", {
    ...
    return /* @__PURE__ */ React50.createElement("div", {
      ...
      if (!block)
        return null;
      return /* @__PURE__ */ React50.createElement(CollectionCard, {
...
var CollectionViewGallery = ({
  ...
  return /* @__PURE__ */ React51.createElement(Gallery, {
    collectionView,
    collection,
    blockIds
  });
...
function Gallery({ blockIds, collectionView, collection }) {
  ...
  return /* @__PURE__ */ React51.createElement("div", {
    ...
    if (!block)
      return null;
    return /* @__PURE__ */ React51.createElement(CollectionCard, {
      collection,
      block,
      cover: gallery_cover,
...
var CollectionViewList = ({
  ...
  if (isGroupedCollection) {
    ...
    return collectionGroups.map((group, key) => /* @__PURE__ */ React52.createElement(CollectionGroup, __spreadProps(__spreadValues({
      key
    }, group), {
  ...
  return /* @__PURE__ */ React52.createElement(List, {
    blockIds,
    collection,
    collectionView
  });
...
function List({ blockIds, collection, collectionView }) {
  ...
  return /* @__PURE__ */ React52.createElement("div", {
    ...
    return /* @__PURE__ */ React52.createElement(components.PageLink, {
      className: "notion-list-item notion-page-link",
      href: mapPageUrl(block.id),
      key: blockId
    }, /* @__PURE__ */ React52.createElement("div", {
      className: "notion-list-item-title"
    }, /* @__PURE__ */ React52.createElement(Property, {
      schema: titleSchema,
      data: titleData,
      block,
      collection,
...
var CollectionViewTable = ({
  ...
  if (isGroupedCollection) {
    ...
    return collectionGroups.map((group, index) => /* @__PURE__ */ React53.createElement(CollectionGroup, __spreadProps(__spreadValues({
      key: index
    }, group), {
      collectionViewComponent: (props) => /* @__PURE__ */ React53.createElement(Table, __spreadProps(__spreadValues({}, props), {
        padding,
        width
      })),
      summaryProps: {
...
function Table({ blockIds = [], collection, collectionView, width, padding }) {
  ...
  return /* @__PURE__ */ React53.createElement("div", {
  ...
  }, !!properties.length && /* @__PURE__ */ React53.createElement(React53.Fragment, null, /* @__PURE__ */ React53.createElement("div", {
    ...
    }, /* @__PURE__ */ React53.createElement(CollectionColumnTitle, {
      schema
    }))));
  }))), /* @__PURE__ */ React53.createElement("div", {
  ...
  }, blockIds == null ? void 0 : blockIds.map((blockId) => /* @__PURE__ */ React53.createElement("div", {
    ...
    return /* @__PURE__ */ React53.createElement("div", {
      ...
      style
    }, /* @__PURE__ */ React53.createElement(Property, {
      schema,
      data,
      block,
      collection,
...
var Collection = ({ block, className, ctx: ctx2 }) => {
  ...
  if (block.type === "page") {
    ...
    return /* @__PURE__ */ React55.createElement(NotionContextProvider, __spreadValues({}, context), /* @__PURE__ */ React55.createElement("div", {
      className: "notion-collection-page-properties"
    }, /* @__PURE__ */ React55.createElement(CollectionRow, {
      block,
      pageHeader: true,
      className
    })));
  } else {
    return /* @__PURE__ */ React55.createElement(NotionContextProvider, __spreadValues({}, context), /* @__PURE__ */ React55.createElement(CollectionViewBlock, {
      block,
      className
    }));
  }
...
var CollectionViewBlock = ({ block, className }) => {
  ...
  return /* @__PURE__ */ React55.createElement(React55.Fragment, null, /* @__PURE__ */ React55.createElement("div", null, /* @__PURE__ */ React55.createElement("div", null, viewIds.length > 1 && showCollectionViewDropdown && /* @__PURE__ */ React55.createElement(CollectionViewTabs, {
    collectionViewId,
    viewIds,
    onChangeView
  })), showTitle && /* @__PURE__ */ React55.createElement("div", {
    className: "notion-collection-header"
  }, /* @__PURE__ */ React55.createElement("div", {
    className: "notion-collection-header-title"
  }, /* @__PURE__ */ React55.createElement(PageIcon, {
    block,
    className: "notion-page-title-icon",
    hideDefaultIcon: true
  }), title))), /* @__PURE__ */ React55.createElement("div", {
    className: cs("notion-collection", className)
  }, /* @__PURE__ */ React55.createElement(CollectionView, {
    collection,
    collectionView,
    collectionData,
    padding,
...
var CollectionViewTabs = ({ collectionViewId, viewIds, onChangeView }) => {
  ...
  return /* @__PURE__ */ React55.createElement("div", {
    ...
    var _a;
    return /* @__PURE__ */ React55.createElement("button", {
    ...
    }, /* @__PURE__ */ React55.createElement(CollectionViewColumnDesc, {
...
var CollectionViewColumnDesc = (_a) => {
  ...
  }, rest), /* @__PURE__ */ React55.createElement(CollectionViewIcon, {
