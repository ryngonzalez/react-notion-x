...
var AssetWrapper = ({ blockId, block }) => {
  ...
  const figure = /* @__PURE__ */ React16.createElement("figure", {
    ...
    block: value,
    zoomable: zoom && !isURL
  }, ((_f = value == null ? void 0 : value.properties) == null ? void 0 : _f.caption) && !isURL && !isVideoParams && value.type !== "video" && /* @__PURE__ */ React16.createElement("figcaption", {
...
var Text = ({ value, block, linkProps, linkProtocol }) => {
  ...
  return /* @__PURE__ */ React21.createElement(React21.Fragment, null, value == null ? void 0 : value.map(([text, decorations], index) => {
    if (!decorations) {
      if (text === ",") {
    ...
    const formatted = decorations.reduce(
      (element, decorator) => {
        ...
        switch (decorator[0]) {
          case "p": {
            ...
            }, /* @__PURE__ */ React21.createElement(PageTitle, {
              block: linkedBlock
            }));
          }
          case "\u2023": {
            ...
            switch (linkType) {
              case "u": {
                ...
                return /* @__PURE__ */ React21.createElement(GracefulImage, {
              ...
              default: {
                ...
                return /* @__PURE__ */ React21.createElement(components.PageLink, __spreadProps(__spreadValues({
                  className: "notion-link",
                  href: mapPageUrl(id)
                }, linkProps), {
                  target: "_blank",
          ...
          case "c":
            return /* @__PURE__ */ React21.createElement("code", {
              className: "notion-inline-code"
            }, element);
          case "b":
            return /* @__PURE__ */ React21.createElement("b", null, element);
          case "i":
            return /* @__PURE__ */ React21.createElement("em", null, element);
          case "s":
            return /* @__PURE__ */ React21.createElement("s", null, element);
          case "_":
            return /* @__PURE__ */ React21.createElement("span", {
              className: "notion-inline-underscore"
            }, element);
          case "e":
            return /* @__PURE__ */ React21.createElement(components.Equation, {
              math: decorator[1],
              inline: true
            });
          case "m":
          ...
          case "a": {
            ...
            if ((v[0] === "/" || v.includes(rootDomain)) && id) {
              ...
              return /* @__PURE__ */ React21.createElement(components.PageLink, __spreadValues({
                className: "notion-link",
                href
              }, linkProps), element);
            } else {
              return /* @__PURE__ */ React21.createElement(components.Link, __spreadValues({
                className: "notion-link",
          ...
          case "eoi": {
            ...
            return /* @__PURE__ */ React21.createElement(EOI, {
      ...
      /* @__PURE__ */ React21.createElement(React21.Fragment, null, text)
    );
    return /* @__PURE__ */ React21.createElement(React21.Fragment, {
      key: index
    }, formatted);
...
var Code = ({ block, defaultLanguage = "typescript", className }) => {
  var _a, _b, _c;
  const [isCopied, setIsCopied] = React23.useState(false);
  const copyTimeout = React23.useRef();
  const { recordMap } = useNotionContext();
  ...
  const onClickCopyToClipboard = React23.useCallback(() => {
  ...
  const copyButton = /* @__PURE__ */ React23.createElement("div", {
    className: "notion-code-copy-button",
    onClick: onClickCopyToClipboard
  }, /* @__PURE__ */ React23.createElement(copy_default, null));
  return /* @__PURE__ */ React23.createElement(React23.Fragment, null, /* @__PURE__ */ React23.createElement("pre", {
    className: cs("notion-code", className)
  }, /* @__PURE__ */ React23.createElement("div", {
    className: "notion-code-copy"
  }, copyButton, isCopied && /* @__PURE__ */ React23.createElement("div", {
    className: "notion-code-copy-tooltip"
  }, /* @__PURE__ */ React23.createElement("div", null, isCopied ? "Copied" : "Copy"))), /* @__PURE__ */ React23.createElement("code", {
    className: `language-${language}`,
    ref: codeRef
  }, content)), caption && /* @__PURE__ */ React23.createElement("figcaption", {
    className: "notion-asset-caption"
