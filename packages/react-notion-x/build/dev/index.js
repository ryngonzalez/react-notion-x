...
var MentionPreviewCard = ({ owner, lastUpdated, externalImage, title, domain }) => {
  ...
  }, capitalizeFirstLetter(domain.split(".")[0]))), /* @__PURE__ */ React10.createElement("div", {
    className: "notion-preview-card-title"
  }, title), owner && /* @__PURE__ */ React10.createElement("div", {
    className: "notion-external-subtitle-item"
  }, /* @__PURE__ */ React10.createElement("div", {
    className: "notion-external-subtitle-item-name"
  }, "Owner"), /* @__PURE__ */ React10.createElement("span", {
    className: "notion-external-subtitle-item-desc"
  }, owner)), lastUpdated && /* @__PURE__ */ React10.createElement("div", {
    className: "notion-external-subtitle-item"
  }, /* @__PURE__ */ React10.createElement("div", {
    className: "notion-external-subtitle-item-name"
  }, "Updated"), /* @__PURE__ */ React10.createElement("span", {
    className: "notion-external-subtitle-item-desc"
  }, lastUpdated)), domain === "github.com" && /* @__PURE__ */ React10.createElement("div", {
...
var EOI = ({ block, inline, className }) => {
  ...
  switch (domain) {
    case "github.com":
      externalImage = /* @__PURE__ */ React11.createElement(type_github_default, null);
      if (owner) {
  ...
  return /* @__PURE__ */ React11.createElement(components.Link, {
    target: "_blank",
  ...
  }, externalImage && /* @__PURE__ */ React11.createElement("div", {
    className: "notion-external-image"
  }, externalImage), /* @__PURE__ */ React11.createElement("div", {
    className: "notion-external-description"
  }, /* @__PURE__ */ React11.createElement("div", {
    className: "notion-external-title"
  }, title), (owner || lastUpdated) && /* @__PURE__ */ React11.createElement(MentionPreviewCard, {
    title,
    owner,
    lastUpdated,
    domain,
...
var GracefulImage = (props) => {
  if (isBrowser) {
    return /* @__PURE__ */ React12.createElement(Img, __spreadValues({}, props));
  } else {
    return /* @__PURE__ */ React12.createElement("img", __spreadValues({}, props));
  }
};
...
var Text = ({ value, block, linkProps, linkProtocol }) => {
  ...
  return /* @__PURE__ */ React13.createElement(React13.Fragment, null, value == null ? void 0 : value.map(([text, decorations], index) => {
    if (!decorations) {
      if (text === ",") {
    ...
    const formatted = decorations.reduce(
      (element, decorator) => {
        ...
        switch (decorator[0]) {
          case "p": {
            ...
            return /* @__PURE__ */ React13.createElement(components.PageLink, {
              className: "notion-link",
              href: mapPageUrl(blockId)
            }, /* @__PURE__ */ React13.createElement(PageTitle, {
              block: linkedBlock
            }));
          }
          case "\u2023": {
            ...
            switch (linkType) {
              case "u": {
                ...
                return /* @__PURE__ */ React13.createElement(GracefulImage, {
              ...
              default: {
                ...
                return /* @__PURE__ */ React13.createElement(components.PageLink, __spreadProps(__spreadValues({
                  className: "notion-link",
                  href: mapPageUrl(id)
                }, linkProps), {
                  target: "_blank",
          ...
          case "c":
            return /* @__PURE__ */ React13.createElement("code", {
              className: "notion-inline-code"
            }, element);
          case "b":
            return /* @__PURE__ */ React13.createElement("b", null, element);
          case "i":
            return /* @__PURE__ */ React13.createElement("em", null, element);
          case "s":
            return /* @__PURE__ */ React13.createElement("s", null, element);
          case "_":
            return /* @__PURE__ */ React13.createElement("span", {
              className: "notion-inline-underscore"
            }, element);
          case "e":
            return /* @__PURE__ */ React13.createElement(components.Equation, {
              math: decorator[1],
              inline: true
            });
          case "m":
          ...
          case "a": {
            ...
            if ((v[0] === "/" || v.includes(rootDomain)) && id) {
              ...
              return /* @__PURE__ */ React13.createElement(components.PageLink, __spreadValues({
                className: "notion-link",
                href
              }, linkProps), element);
            } else {
              return /* @__PURE__ */ React13.createElement(components.Link, __spreadValues({
                className: "notion-link",
          ...
          case "eoi": {
            ...
            return /* @__PURE__ */ React13.createElement(EOI, {
      ...
      /* @__PURE__ */ React13.createElement(React13.Fragment, null, text)
    );
    return /* @__PURE__ */ React13.createElement(React13.Fragment, {
      key: index
    }, formatted);
...
var PageTitleImpl = (_a) => {
  ...
  if (block.type === "collection_view_page" || block.type === "collection_view") {
    ...
    }, rest), /* @__PURE__ */ React14.createElement(PageIcon, {
      block,
      defaultIcon,
...
var PageTitle = React14.memo(PageTitleImpl);
...
var LiteYouTubeEmbed = ({
  ...
  const queryString = React19.useMemo(
  ...
  const [isPreconnected, setIsPreconnected] = React19.useState(false);
  const [iframeInitialized, setIframeInitialized] = React19.useState(defaultPlay);
  const [isIframeLoaded, setIsIframeLoaded] = React19.useState(false);
  const warmConnections = React19.useCallback(() => {
    if (isPreconnected)
      return;
    setIsPreconnected(true);
  }, [isPreconnected]);
  const onLoadIframe = React19.useCallback(() => {
    if (iframeInitialized)
      return;
    setIframeInitialized(true);
  }, [iframeInitialized]);
  const onIframeLoaded = React19.useCallback(() => {
    setIsIframeLoaded(true);
  }, []);
  return /* @__PURE__ */ React19.createElement(React19.Fragment, null, /* @__PURE__ */ React19.createElement("link", {
    rel: "preload",
    href: posterUrl,
    as: "image"
  }), isPreconnected && /* @__PURE__ */ React19.createElement(React19.Fragment, null, /* @__PURE__ */ React19.createElement("link", {
    rel: "preconnect",
    href: ytUrl
  }), /* @__PURE__ */ React19.createElement("link", {
    rel: "preconnect",
    href: "https://www.google.com"
  })), isPreconnected && adLinksPreconnect && /* @__PURE__ */ React19.createElement(React19.Fragment, null, /* @__PURE__ */ React19.createElement("link", {
    rel: "preconnect",
  ...
  }), iframeInitialized && /* @__PURE__ */ React19.createElement("iframe", {
    width: "560",
    height: "315",
    frameBorder: "0",
...
var Asset = ({ block, zoomable = true, children }) => {
  ...
  if (block.type === "tweet") {
    ...
    if (!id)
      return null;
    content = /* @__PURE__ */ React20.createElement("div", {
    ...
    }, /* @__PURE__ */ React20.createElement(components.Tweet, {
      id
    }));
    ...
    if (!isServer) {
      content = /* @__PURE__ */ React20.createElement(components.Pdf, {
        file: source
      });
    }
    ...
    if (block.type === "video" && source && source.indexOf("youtube") < 0 && source.indexOf("youtu.be") < 0 && source.indexOf("vimeo") < 0 && source.indexOf("wistia") < 0 && source.indexOf("loom") < 0 && source.indexOf("videoask") < 0 && source.indexOf("getcloudapp") < 0) {
      ...
      content = /* @__PURE__ */ React20.createElement("video", {
      ...
      if (src) {
        ...
        if (youtubeVideoId) {
          content = /* @__PURE__ */ React20.createElement(LiteYouTubeEmbed, {
            id: youtubeVideoId,
            style: assetStyle,
          ...
          style.paddingBottom = "50%";
          content = /* @__PURE__ */ React20.createElement("iframe", {
            style: assetStyle,
            className: "notion-asset-object-fit",
            src,
            title: "GitHub Gist",
...
var AssetWrapper = ({ blockId, block }) => {
  ...
  const figure = /* @__PURE__ */ React21.createElement("figure", {
    className: cs(
    ...
    block: value,
    zoomable: zoom && !isURL
  }, ((_f = value == null ? void 0 : value.properties) == null ? void 0 : _f.caption) && !isURL && !isVideoParams && value.type !== "video" && /* @__PURE__ */ React21.createElement("figcaption", {
  ...
  if (isURL) {
    ...
    return /* @__PURE__ */ React21.createElement(components.PageLink, {
      style: urlStyle,
...
var Audio = ({ block, className }) => {
  ...
  }, /* @__PURE__ */ React22.createElement("audio", {
    controls: true,
    preload: "none",
    src: source
  }));
...
var FileIcon = (props) => {
  const _a = props, { className } = _a, rest = __objRest(_a, ["className"]);
  return /* @__PURE__ */ React23.createElement("svg", __spreadProps(__spreadValues({
    className
  }, rest), {
    viewBox: "0 0 30 30"
...
var File = ({ block, className }) => {
  ...
  return /* @__PURE__ */ React24.createElement("div", {
    ...
    target: "_blank",
    rel: "noopener noreferrer"
  }, /* @__PURE__ */ React24.createElement(FileIcon, {
    ...
    block
  })), ((_e = block.properties) == null ? void 0 : _e.size) && /* @__PURE__ */ React24.createElement("div", {
...
var GoogleDrive = ({ block, className }) => {
  ...
  }, /* @__PURE__ */ React25.createElement(components.Link, {
...
var PageAside = ({
  ...
  const actionSectionScrollSpy = React26.useMemo(
  ...
  return /* @__PURE__ */ React26.createElement("aside", {
    className: cs("notion-aside", className)
  }, hasToc && /* @__PURE__ */ React26.createElement("div", {
    className: "notion-aside-table-of-contents"
  }, /* @__PURE__ */ React26.createElement("div", {
    className: "notion-aside-table-of-contents-header"
  }, "Table of Contents"), /* @__PURE__ */ React26.createElement("nav", {
    className: "notion-table-of-contents"
  }, toc.map((tocItem) => {
    const id = uuidToId(tocItem.id);
    return /* @__PURE__ */ React26.createElement("a", {
      key: id,
      href: `#${id}`,
      className: cs(
...
var LinkIcon = (props) => {
  const _a = props, { className } = _a, rest = __objRest(_a, ["className"]);
  return /* @__PURE__ */ React28.createElement("svg", __spreadProps(__spreadValues({
    className
  }, rest), {
    viewBox: "0 0 16 16",
    width: "16",
...
var Block = (props) => {
  ...
  const [activeSection, setActiveSection] = React29.useState(null);
  const {
    block,
    children,
    level,
  ...
  switch (block.type) {
    ...
    case "page":
      if (level === 0) {
        ...
        if (fullPage) {
          ...
          }, !disableHeader && /* @__PURE__ */ React29.createElement(components.Header, {
            block
          }), header, /* @__PURE__ */ React29.createElement("div", {
            className: "notion-page-scroller"
          }, hasPageCover && (pageCover ? pageCover : /* @__PURE__ */ React29.createElement("div", {
          ...
          }))), /* @__PURE__ */ React29.createElement("main", {
            className: cs(
              "notion-page",
          ...
          }, page_icon && /* @__PURE__ */ React29.createElement(PageIcon, {
            block,
            defaultIcon: defaultPageIcon,
            inline: false
          }), pageHeader, /* @__PURE__ */ React29.createElement("h1", {
            className: "notion-title"
          }, pageTitle != null ? pageTitle : /* @__PURE__ */ React29.createElement(Text, {
            value: properties == null ? void 0 : properties.title,
            block
          })), (block.type === "collection_view_page" || block.type === "page" && block.parent_table === "collection") && /* @__PURE__ */ React29.createElement(components.Collection, {
            block,
            ctx: ctx2
          }), block.type !== "collection_view_page" && /* @__PURE__ */ React29.createElement("div", {
            className: cs(
              "notion-page-content",
              hasAside && "notion-page-content-has-aside",
              hasToc && "notion-page-content-has-toc"
            )
          }, /* @__PURE__ */ React29.createElement("article", {
            className: "notion-page-content-inner"
          }, children), hasAside && /* @__PURE__ */ React29.createElement(PageAside, {
            toc,
            activeSection,
            setActiveSection,
            hasToc,
          ...
          return /* @__PURE__ */ React29.createElement("main", {
            className: cs(
              "notion",
              darkMode ? "dark-mode" : "light-mode",
              "notion-page",
            ...
            className: "notion-viewport"
          }), pageHeader, (block.type === "collection_view_page" || block.type === "page" && block.parent_table === "collection") && /* @__PURE__ */ React29.createElement(components.Collection, {
            block,
            ctx: ctx2
        ...
        return /* @__PURE__ */ React29.createElement(components.PageLink, {
          className: cs(
            "notion-page-link",
        ...
        }, /* @__PURE__ */ React29.createElement(PageTitle, {
          block
        }));
      }
    case "header":
    ...
    case "sub_sub_header": {
      ...
      const innerHeader = /* @__PURE__ */ React29.createElement("span", null, /* @__PURE__ */ React29.createElement("div", {
        id,
        className: "notion-header-anchor"
      }), !((_f = block.format) == null ? void 0 : _f.toggleable) && /* @__PURE__ */ React29.createElement("a", {
        className: "notion-hash-link",
        href: `#${id}`,
        title
      }, /* @__PURE__ */ React29.createElement(LinkIcon, null)), /* @__PURE__ */ React29.createElement("span", {
      ...
      if (isH1) {
        headerBlock = /* @__PURE__ */ React29.createElement("h2", {
          className: classNameStr,
          "data-id": id
        }, innerHeader);
      } else if (isH2) {
        headerBlock = /* @__PURE__ */ React29.createElement("h3", {
          className: classNameStr,
          "data-id": id
        }, innerHeader);
      } else {
        headerBlock = /* @__PURE__ */ React29.createElement("h4", {
          className: classNameStr,
          "data-id": id
        }, innerHeader);
      }
      if ((_g = block.format) == null ? void 0 : _g.toggleable) {
        return /* @__PURE__ */ React29.createElement("details", {
          className: cs("notion-toggle", blockId)
        }, /* @__PURE__ */ React29.createElement("summary", null, headerBlock), /* @__PURE__ */ React29.createElement("div", null, children));
      } else {
        return headerBlock;
      }
    }
    case "divider":
      return /* @__PURE__ */ React29.createElement("hr", {
    ...
    case "text": {
      ...
      }, ((_j = block.properties) == null ? void 0 : _j.title) && /* @__PURE__ */ React29.createElement(Text, {
        value: block.properties.title,
        block
      }), children && /* @__PURE__ */ React29.createElement("div", {
        className: "notion-text-children"
      }, children));
    }
    case "bulleted_list":
    case "numbered_list": {
      const wrapList = (content, start2) => block.type === "bulleted_list" ? /* @__PURE__ */ React29.createElement("ul", {
        className: cs("notion-list", "notion-list-disc", blockId)
      }, content) : /* @__PURE__ */ React29.createElement("ol", {
        start: start2,
        className: cs("notion-list", "notion-list-numbered", blockId)
      }, content);
      let output = null;
      if (block.content) {
        output = /* @__PURE__ */ React29.createElement(React29.Fragment, null, block.properties && /* @__PURE__ */ React29.createElement("li", null, /* @__PURE__ */ React29.createElement(Text, {
          value: block.properties.title,
          block
        })), wrapList(children));
      } else {
        output = block.properties ? /* @__PURE__ */ React29.createElement("li", null, /* @__PURE__ */ React29.createElement(Text, {
          value: block.properties.title,
          block
        })) : null;
      }
    ...
    case "embed":
      return /* @__PURE__ */ React29.createElement(components.Embed, {
        blockId,
        block
      });
    case "replit":
    ...
    case "gist":
    case "video":
      return /* @__PURE__ */ React29.createElement(AssetWrapper, {
        blockId,
        block
      });
    case "drive": {
      ...
      return /* @__PURE__ */ React29.createElement(GoogleDrive, {
        block,
        className: blockId
      });
    }
    case "audio":
      return /* @__PURE__ */ React29.createElement(Audio, {
        block,
        className: blockId
      });
    case "file":
      return /* @__PURE__ */ React29.createElement(File, {
        block,
        className: blockId
      });
    case "equation":
      return /* @__PURE__ */ React29.createElement(components.Equation, {
        block,
        inline: false,
        className: blockId
      });
    case "code":
      return /* @__PURE__ */ React29.createElement(components.Code, {
        block
      });
    case "column_list":
      return /* @__PURE__ */ React29.createElement("div", {
    ...
    case "quote": {
      ...
      return /* @__PURE__ */ React29.createElement("blockquote", {
        className: cs(
          "notion-quote",
          blockColor && `notion-${blockColor}`,
          blockId
        )
      }, /* @__PURE__ */ React29.createElement("div", null, /* @__PURE__ */ React29.createElement(Text, {
        value: block.properties.title,
        block
      })), children);
    }
    case "collection_view":
      return /* @__PURE__ */ React29.createElement(components.Collection, {
        block,
        className: blockId,
        ctx: ctx2
      });
    case "callout":
      if (components.Callout) {
        return /* @__PURE__ */ React29.createElement(components.Callout, {
          block,
          className: blockId
        });
      } else {
        ...
        }, /* @__PURE__ */ React29.createElement(PageIcon, {
          block
        }), /* @__PURE__ */ React29.createElement("div", {
    ...
    case "bookmark": {
      ...
      return /* @__PURE__ */ React29.createElement("div", {
      ...
      }, /* @__PURE__ */ React29.createElement(components.Link, {
        target: "_blank",
        rel: "noopener noreferrer",
        className: cs(
          "notion-bookmark",
        ...
        href: link[0][0]
      }, /* @__PURE__ */ React29.createElement("div", null, title && /* @__PURE__ */ React29.createElement("div", {
        className: "notion-bookmark-title"
      }, /* @__PURE__ */ React29.createElement(Text, {
        value: [[title]],
        block
      })), ((_x = block.properties) == null ? void 0 : _x.description) && /* @__PURE__ */ React29.createElement("div", {
      ...
      }, ((_z = block.format) == null ? void 0 : _z.bookmark_icon) && /* @__PURE__ */ React29.createElement("div", {
        ...
        value: link,
        block
      })))), ((_B = block.format) == null ? void 0 : _B.bookmark_cover) && /* @__PURE__ */ React29.createElement("div", {
    ...
    case "toggle":
      return /* @__PURE__ */ React29.createElement("details", {
        className: cs("notion-toggle", blockId)
      }, /* @__PURE__ */ React29.createElement("summary", null, /* @__PURE__ */ React29.createElement(Text, {
        value: (_E = block.properties) == null ? void 0 : _E.title,
        block
      })), /* @__PURE__ */ React29.createElement("div", null, children));
    case "table_of_contents": {
      ...
      }, toc.map((tocItem) => /* @__PURE__ */ React29.createElement("a", {
        key: tocItem.id,
    ...
    case "to_do": {
      ...
      }, /* @__PURE__ */ React29.createElement(components.Checkbox, {
        blockId,
        isChecked
      }), /* @__PURE__ */ React29.createElement("div", {
        className: cs(
    ...
    case "transclusion_reference":
      return /* @__PURE__ */ React29.createElement(SyncPointerBlock, __spreadValues({
        block,
        level: level + 1
      }, props));
    case "alias": {
    ...
    case "table":
      ...
      }, /* @__PURE__ */ React29.createElement("tbody", null, children));
    case "table_row": {
      ...
      return /* @__PURE__ */ React29.createElement("tr", {
        className: cs(
        ...
        return /* @__PURE__ */ React29.createElement("td", {
          key: column,
    ...
    case "external_object_instance":
      return /* @__PURE__ */ React29.createElement(EOI, {
        block,
        className: blockId
      });
    default:
      ...
      return /* @__PURE__ */ React29.createElement("div", null);
  }
  return null;
};
...
var NotionRenderer = (_a) => {
  ...
  return /* @__PURE__ */ React30.createElement(NotionContextProvider, {
    components,
    recordMap,
    mapPageUrl,
    mapImageUrl,
  ...
  }, /* @__PURE__ */ React30.createElement(NotionBlockRenderer, __spreadValues({}, rest)));
};
var NotionBlockRenderer = (_a) => {
  ...
  return /* @__PURE__ */ React30.createElement(Block, __spreadValues({
    key: id,
    level,
    block
  }, props), (_b2 = block == null ? void 0 : block.content) == null ? void 0 : _b2.map((contentBlockId) => /* @__PURE__ */ React30.createElement(NotionBlockRenderer, __spreadValues({
    key: contentBlockId,
